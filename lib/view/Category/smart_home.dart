...
class _SmartHomeState extends State<SmartHome> with TickerProviderStateMixin {
  ...
  Future<void> _loadCategoryProducts() async {
    ...
    try {
      ...
      await productController.fetchProductsByCategoryName('Smart Home');
