...
Future<void> _loadCategoryProducts() async {
  ...
  try {
    ...
    // This will dynamically find the category ID and load products
    await productController.fetchProductsByCategoryName('HighTech');
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            // Replace the favorite icon section with this:
            Positioned(
              top: 8.h,
              right: 8.w,
              child: Consumer<ProductController>(
                builder: (context, productController, child) {
                  // Get the current product from the controller's current category products
