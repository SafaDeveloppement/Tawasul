...
//                       children: [
//                         Text(
//                           '${product.price.toStringAsFixed(2)} ${t.lyd}', // Format to 2 decimal places
//                           style: TextStyle(
//                             fontSize: 16.sp,
//                             fontWeight: FontWeight.bold,
//                             color: const Color(0xFF0984E3),
...
//                             child: Text(
//                               '${product.oldPrice!.toStringAsFixed(2)} ${t.lyd}', // Format to 2 decimal places
//                               style: TextStyle(
//                                 fontSize: 14.sp,
//                                 color: Colors.grey,
...
class _HomePageState extends State<HomePage> {
  ...
  // ADD THIS METHOD TO BUILD NEWEST PRODUCTS SECTION
  Widget _buildNewestProductsSection(AppLocalizations t) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionTitle(
          t.newest, // Make sure this translation exists in your AppLocalizations
          onTap: () {
            // Optional: Navigate to a dedicated Newest products page
            print("See all newest products");
          },
          seeAllText: t.seeAll, // Make sure this translation exists
        ),
        SizedBox(height: 10.h),

        // Use the Newest widget here
        Container(
          height: 220.h, // Adjust height as needed
          child: Newest(),
        ),

        SizedBox(height: 20.h), // Add spacing after newest section
      ],
    );
  }
  ...
  Widget _buildOriginalContent(AppLocalizations t) {
    ...
    return Column(
      children: [
        ...
        // ADD NEWEST PRODUCTS SECTION HERE (BEFORE FLASH SALE)
        _buildNewestProductsSection(t),
