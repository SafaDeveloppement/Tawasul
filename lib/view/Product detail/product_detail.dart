...
class _ProductDetailState extends State<ProductDetail> {
  ...
  Future<void> _fetchProductDetail() async {
    try {
      ...
      final result = await ApiService.getProductDetail(productId: productId);
  ...
  void _addToCart() async {
    ...
    try {
      ...
      final result = await ApiService.addToCart(
        ...
        quantity: quantity,
        productAttributeId: _selectedColor?.idAttribute.toString(),
      );
      ...
      if (result['success'] == true) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (_) => ShoppingCart(cartId: cartId ?? '')),
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
...
// void _addToCart() async {
  ...
  //     // Call API directly or via your provider, but get the result map
  //     final result = await ApiService.addToCart(
  //       productId: product!.idProduct.toString(),
  //       quantity: quantity,
  //       productAttributeId: attributeId,
  ...
  //     if (result['success'] == true && result['id_cart'] != null) {
  //       final String cartId = result['id_cart'];
  //       print(" Product added, navigating to cart with ID: $cartId");

  //       // Navigate to ShoppingCart page with dynamic cartId
  //       Navigator.pushReplacement(
  //         context,
  //         MaterialPageRoute(builder: (_) => ShoppingCart(cartId: cartId)),
  //       );
