...
class _ProductDetailState extends State<ProductDetail> {
  ...
  Widget _buildColorDots() {
    if (product == null || product!.parsedColorsWithNames.isEmpty) {
      return const SizedBox.shrink();
    }

    final colorPairs = product!.parsedColorsWithNames;
    print("Building UI for ${colorPairs.length} color dots");
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.palette, size: 20.sp, color: const Color(0xFF008AD2)),
              SizedBox(width: 8.w),
              Text(
                'Available Colors',
                style: TextStyle(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            ...
                            width: _selectedColorName == name ? 2.5 : 1.2,
                          ),
                          boxShadow: [
                            if (_selectedColorName == name)
                              BoxShadow(
