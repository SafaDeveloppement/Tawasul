...
class Newest extends StatefulWidget {
  // Remove shopId parameter since we don't need it for this API
...
class _NewestState extends State<Newest> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // Fetch newest products without shopId
  ...
  Widget build(BuildContext context) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16.h),
              Text(
                "Failed to load newest products",
                style: TextStyle(fontSize: 16.sp, color: Colors.red),
                textAlign: TextAlign.center,
              ),
              SizedBox(height: 8.h),
    ...
    print("🆕 Displaying ${newestProducts.length} newest products");
    ...
    return RefreshIndicator(
      onRefresh: () async {
        await productController.fetchNewestProducts(limit: 10);
      },
      child: SingleChildScrollView(
        scrollDirection: Axis.horizontal,
        padding: EdgeInsets.symmetric(vertical: 8.h),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        "${product.price.toStringAsFixed(3)} LYD",
                        style: TextStyle(
                          fontSize: 13.sp,
                          color: const Color(0xFF0984E3),
                          fontWeight: FontWeight.bold,
